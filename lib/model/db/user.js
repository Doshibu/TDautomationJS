...
function get_instance_methods (sequelize) {
  return {
    ...
    // managed by current users + user itslef, so it should be something likne
     ...
     *
     * */
    promise_number_of_days_available_in_allowance: function (year) {
      let self = this
      ...
      return self
        ...
        .promise_total_number_of_days_in_allowance(year)
