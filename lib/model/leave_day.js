...
LeaveDay.prototype.is_all_day_leave = function () {
  return String(this.day_part) === String(this.sequelize.models.Leave.leave_day_part_all())
}

LeaveDay.prototype.is_morning_leave = function () {
  return String(this.day_part) === String(this.sequelize.models.Leave.leave_day_part_morning())
}

LeaveDay.prototype.is_afternoon_leave = function () {
  return String(this.day_part) === String(this.sequelize.models.Leave.leave_day_part_afternoon())
}
